 ...
 * @author Diego
 */
public class FrmMenuC extends javax.swing.JFrame {

    /**
     * Creates new form FrmMenuC
     */
    public FrmMenuC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, -1, 60));
        ...
        jPanel1.add(btnMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 128, 128));

        btnCuenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnMiCuenta.png"))); // NOI18N
        btnCuenta.setFocusPainted(false);
        btnCuenta.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnCuenta.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnMiCuenta.png"))); // NOI18N
        btnCuenta.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnMiCuentaPresionado.png"))); // NOI18N
        btnCuenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCuentaActionPerformed(evt);
            }
        });
        jPanel1.add(btnCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 128, 128));

        btnEntrega.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnProveedores.png"))); // NOI18N
        btnEntrega.setFocusPainted(false);
        btnEntrega.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnEntrega.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnProveedores.png"))); // NOI18N
        btnEntrega.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnProveedoresPresionado.png"))); // NOI18N
        btnEntrega.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEntregaActionPerformed(evt);
            }
        });
        jPanel1.add(btnEntrega, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 128, 128));
        ...
        jPanel1.add(btnPedidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 180, 128, 128));
        ...
        jLabel8.setText("Ver estatus de entrega");
        jLabel8.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, -1));
        ...
        jPanel1.add(btnAcercaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 570, -1, -1));
        jPanel1.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 540, 80, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMenuC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
